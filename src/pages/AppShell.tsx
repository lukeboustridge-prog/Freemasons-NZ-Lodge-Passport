...
export default function AppShell() {
  ...
  const lodges: Lodge[] = [
    { id: "l1", name: "Lodge Example No. 123", joinDate: "2019-03-15" },
    { id: "l2", name: "Corinthian Lodge No. 45", joinDate: "2021-06-10", resignedDate: "2023-11-20" },
  ];
  ...
  const lodgesForVisits = lodges.map(l => ({ id: l.id, name: l.name }));
          ...
          <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <main className="max-w-5xl mx-auto p-4 sm:p-6">
              <Routes>
                ...
                <Route path="/dashboard" element={<Dashboard offices={offices as any} />} />
                <Route path="/profile" element={<ProfilePage />} />
                <Route path="/offices" element={<OfficesPage />} />
                <Route path="/milestones" element={<MilestonesScreen milestones={milestones as any} onSave={()=>{}} onUpdate={()=>{}} />} />
                <Route path="/visits" element={<VisitsScreen visits={visits as any} lodges={lodgesForVisits as any} onSave={()=>{}} onUpdate={()=>{}} />} />
